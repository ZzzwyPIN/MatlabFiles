...
for i=1:length(snr_in_dB)
   ...
   Pe_4(i)=(2/3)*quad('Bdt_int',minus_inf,plus_inf,tolerance,[],snr,4);
   Pe_8(i)=(4/7)*quad('Bdt_int',minus_inf,plus_inf,tolerance,[],snr,8);
   Pe_16(i)=(8/15)*quad('Bdt_int',minus_inf,plus_inf,tolerance,[],snr,16);
   Pe_32(i)=(16/31)*quad('Bdt_int',minus_inf,plus_inf,tolerance,[],snr,32);
   Pe_64(i)=(32/63)*quad('Bdt_int',minus_inf,plus_inf,tolerance,[],snr,64);
   echo off;
end;
